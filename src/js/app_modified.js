...
App = {
  ...
  addCandidate: function(){
   ...
   var dta= "insert into registered_users(name,age,party,qualification) values(name,age,party,qualification)"
    App.contracts.Contest.deployed().then(function(instance){
...
//     if (err) throw err;
    var sql = "INSERT INTO registered_users(name,age,party,qualification) VALUES('admin', 'admin', 'male', 'admin@admin.com')";
    con.query(sql, function (err, result) {
        if (err) throw err;
